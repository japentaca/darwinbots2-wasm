...
- La carrera evo de `Evo.bas` y su variante de red eco-IM (E5, E7), la
  ...
  inspector de E2).
- Límite heredado de E5: la ronda nueva no regenera las formas desde
...
familia `70-CASOS-DORADOS.md §15`). Sigue abierto también el límite
heredado de E5 (formas en ronda nueva).
